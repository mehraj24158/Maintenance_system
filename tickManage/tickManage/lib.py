...
from tickManage.models import FollowUpAttachment, EmailTemplate
...
def process_attachments(followup, attached_files):
    max_email_attachment_size = getattr(settings, 'TICKMANAGE_MAX_EMAIL_ATTACHMENT_SIZE', 512000)
    attachments = []
    ...
    for attached in attached_files:
        ...
        if attached.size:
            ...
            if attached.size < max_email_attachment_size:
                ...
                # settings.TICKMANAGE_MAX_EMAIL_ATTACHMENT_SIZE) are sent via email.
