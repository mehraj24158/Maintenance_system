...
from tickManage.models import CustomField, KBItem, Queue
...
class AbstractCreateTicketMixin():
    def get_initial(self):
        ...
        try:
            ...
            pass
        if request.user.is_authenticated and request.user.usersettings_tickManage.use_email_as_submitter and request.user.email:
